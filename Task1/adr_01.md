...
- Урвень С1 (_контекст системы_) отображает общее положение системы в её окружении и взаимодействие с внешними актерами и системами, а не конкретные технические детали реализации, поэтому альтернативные варианты архитектуры на этом уровне не рассматриваются.
